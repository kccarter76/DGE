...
bool	LightShader::SetShaderParameters( ID3D11DeviceContext* context, D3DXMATRIX world, D3DXMATRIX view, D3DXMATRIX projection, ID3D11ShaderResourceView* texture, D3DXVECTOR3 direction, D3DXVECTOR4 color )
{
	HRESULT						result;
	...
	light_buffer_type->diffuse_color	= color;
	light_buffer_type->light_direction	= direction;
	light_buffer_type->padding = 0.0f;
...
bool	LightShader::Render( ID3D11DeviceContext* context, int cnt, D3DXMATRIX world, D3DXMATRIX view, D3DXMATRIX projection, ID3D11ShaderResourceView* texture, D3DXVECTOR3 direction, D3DXVECTOR4 color)
{
	if ( this->SetShaderParameters( context, world, view, projection, texture, direction, color ) )
	{
