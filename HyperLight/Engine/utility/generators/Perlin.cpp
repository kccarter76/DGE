...
// static variables
CSimplexNoise::LPGradient	CSimplexNoise::Gradient3D[] = {
...
CSimplexNoise::LPGradient	CSimplexNoise::Gradient4D[] = {
...
double	CSimplexNoise::noise( double xin, double yin )
{
	...
	{
		t0 *= t0;
		n0	= t0 * t0 * dot( *Gradient3D[gi0], x0, y0 );
	}
