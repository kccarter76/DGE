...
LARGE_INTEGER DaTimer::GetAdjustedCurrentTime(void)
{
...
void DaTimer::GetTimeValues(double* pfTime, double* pfAbsoluteTime, float* pfElapsedTime)
{
...
void DaTimer::LimitThreadAffinityToCurrentProc(void)
{
	HANDLE 
